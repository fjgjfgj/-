  ...
  <div id="skin-toolbox">
    <div class="panel">
      <div class="panel-heading">
        ...
        <span class="panel-title"> Layout Options</span>
      </div>
  ...
  <div id="main">
    ...
    <header class="navbar navbar-fixed-top navbar-shadow">
      <div class="navbar-branding">
        <a class="navbar-brand" href="/advanced/frontend/web">
          Hello<b>Nankai</b>
        </a>
    ...
    <aside id="sidebar_left" class="nano nano-light affix">
      ...
      <div class="sidebar-left-content nano-content">
        ...
        <ul class="nav sidebar-menu">
          ...
          <li>
            <a href="/advanced/frontend/web/index.php?r=site/team">
              <span class="glyphicon glyphicon-user"></span>
              <span class="sidebar-title">Team</span>
            </a>
          </li>

          <li class="sidebar-label pt15">Project</li>
          <li>
            <a href="dashboard.html">
              <span class="glyphicon glyphicon-th"></span>
              <span class="sidebar-title">view01</span>
            </a>
          </li>
          <li>
            <a href="dashboard.html">
              <span class="glyphicon glyphicon-th"></span>
              <span class="sidebar-title">view02</span>
            </a>
          </li>
          <li>
            ...
            <ul class="nav sub-nav">
              <li>
                <a href="/advanced/frontend/web/index.php?r=characters/index">
                  <span class="glyphicon glyphicon-shopping-cart"></span>form01</a>
              </li>
              <li>
                <a href="admin_forms-widgets.html">
                  <span class="glyphicon glyphicon-calendar"></span>form02</a>
              </li>
              <li>
                <a href="admin_forms-layouts.html">
                  <span class="fa fa-desktop"></span>form03</a>
              </li>
              <li>
                <a href="admin_forms-wizard.html">
                  <span class="fa fa-clipboard"></span>form04</a>
              </li>
              <li>
                <a href="admin_forms-validation.html">
                  <span class="glyphicon glyphicon-check"></span>form05</a>
              </li>
            </ul>
          </li>
        </ul>
